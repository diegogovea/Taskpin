...
export default function CatH4Screen() {
  ...
  // Función para obtener los hábitos de la categoría 4 (Orden y Hogar)
  const fetchHabitos = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/habitos/categoria/4`);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.mainTitle}>Orden y Hogar</Text>
          <Text style={styles.subtitle}>Organización doméstica y mantenimiento del hogar 🏡</Text>
        </View>

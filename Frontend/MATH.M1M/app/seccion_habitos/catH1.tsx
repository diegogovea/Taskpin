...
export default function CatH1Screen() {
  ...
  // Función para obtener los hábitos de la categoría 1 (Bienestar Diario)
  const fetchHabitos = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/habitos/categoria/1`);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.mainTitle}>Bienestar Diario</Text>
          <Text style={styles.subtitle}>Hábitos de cuidado personal básico y rutinas saludables 🌿</Text>
        </View>

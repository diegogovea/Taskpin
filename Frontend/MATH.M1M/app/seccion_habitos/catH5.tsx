...
export default function CatH5Screen() {
  ...
  // Función para obtener los hábitos de la categoría 5 (Finanzas y Control Personal)
  const fetchHabitos = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/habitos/categoria/5`);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.mainTitle}>Finanzas y Control Personal</Text>
          <Text style={styles.subtitle}>Hábitos para el manejo responsable del dinero 💸</Text>
        </View>
